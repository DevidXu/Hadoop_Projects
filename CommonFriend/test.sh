...
javac -classpath ${HADOOP_CLASSPATH} -d '/home/dewei/Hadoop/Workspace/CommonFriend/classes' -target 1.8 -source 1.8 CommonFriend.java
jar -cvf CommonFriend.jar -C classes/ .
printf "\n${RED}Jar package has been compiled! ${NC}\n\n"

hadoop jar CommonFriend.jar CommonFriend /Tutorial/Input /Tutorial/Output
